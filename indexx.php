            ...
            <ul>
              ...
              <li data-index="rs-1" data-transition="fade" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/slide-bg-1.jpg" data-rotate="0"  data-fstransition="fade" data-saveperformance="off" data-title="Web Show" data-description="">
                ...
                <div class="tp-caption tp-resizeme rs-parallaxlevel-0 text-white text-uppercase font-roboto-slab font-weight-700" 
                  ...
                  data-splitout="none" 
                  data-responsive_offset="on" 
                  style="z-index: 5; white-space: nowrap; font-weight:700;">لماذا نحن
                </div>
                <!-- LAYER NR. 3 -->
                <div class="tp-caption tp-resizeme text-white rs-parallaxlevel-0" 
                  ...
                  data-splitout="none" 
                  data-responsive_offset="on" 
                  style="z-index: 5; white-space: nowrap;">تتمحور أهدافنا حول الطالب ، الثقة ، الإيمان بالعمل الجماعي التناغم ، النمو البناء ، النمو المربح و الابتكار                </div>
                <!-- LAYER NR. 4 -->
                <div class="tp-caption rs-parallaxlevel-0" 
                  ...
                  data-responsive_offset="on" 
                  data-responsive="off"
                  style="z-index: 5; white-space: nowrap; letter-spacing:1px;"><a class="btn btn-theme-colored2 btn-lg btn-flat text-white font-weight-600 pl-30 pr-30 mr-15" href="contact.php">اتصل بنا</a>
                </div>
              </li>
              ...
              <li data-index="rs-2" data-transition="fade" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/slide-bg-2.jpg" data-rotate="0"  data-fstransition="fade" data-saveperformance="off" data-title="Web Show" data-description="">
                ...
                <div class="tp-caption tp-resizeme rs-parallaxlevel-0 text-white text-uppercase font-roboto-slab font-weight-700" 
                  ...
                  data-splitout="none" 
                  data-responsive_offset="on" 
                  style="z-index: 5; white-space: nowrap; font-weight:700;">مجالات التدريب
                </div>
                <!-- LAYER NR. 3 -->
                <div class="tp-caption tp-resizeme text-white rs-parallaxlevel-0" 
                  id="slide-2-layer-3" 
                  ...
                  data-splitout="none" 
                  data-responsive_offset="on" 
                  style="z-index: 5; white-space: nowrap;">التدريب الإداري والتربوي- الحاسب الآلي - الدورات الهندسية والفنية – اللغات الأجنبية 
                </div>
                <!-- LAYER NR. 4 -->
                <div class="tp-caption rs-parallaxlevel-0" 
                  id="slide-2-layer-4" 
              ...
              <li data-index="rs-3" data-transition="fade" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/slide-bg-3.jpg" data-rotate="0"  data-fstransition="fade" data-saveperformance="off" data-title="Web Show" data-description="">
                ...
                <div class="tp-caption tp-resizeme rs-parallaxlevel-0 text-white text-uppercase font-roboto-slab font-weight-700" 
                  ...
                  data-splitout="none" 
                  data-responsive_offset="on" 
                  style="z-index: 5; white-space: nowrap; font-weight:700;">شعارنا 
                </div>
                <!-- LAYER NR. 3 -->
                <div class="tp-caption tp-resizeme text-white rs-parallaxlevel-0" 
                  id="slide-3-layer-3" 
                  ...
                  data-splitout="none" 
                  data-responsive_offset="on" 
                  style="z-index: 5; white-space: nowrap;">تدريب نوعي غايته التميز<br>
    ...
    ?>
              ...
              <div class="course-details border-1px clearfix p-15 pt-15">
                <div class="course-top-part">
                   <a href="details1.php?ID=<? echo $row['ID']; ?>"><h5 class="line-bottom-centered mt-20 mb-30"><? echo $row['cors_name'];
...
<a href="conditions.php"   target=_blank> <i class="fa fa-circle-o  btn btn-info btn-sm "> </i>  للإطلاع علي الشروط والاحكام</a>                      </div>
                    </div>
...
الدورات الإدارية والتربوية والقانوينة
                  ...
                  <div id="collapse3" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading3">
                    <div class="panel-body"><p align="justify">لا يستطيع المرء أن يتجاهل المزايا المتعددة للدورات التدريبية أو يقلل من شأنها، حيث أصبحت تشكل أهمية كبرى في سُمو النفس والبحث عن ما هو أجود وأفضل 
                    </div>
                  </div>
                </div>
...
{
?> 
<div class="item"> <a href="#"><img src="images/partners/<? echo $row['Partners']; ?>" alt=""/  style="width:200px;height:120px"></a></div>
<?php } ?>            
            </div>
          </div>
        </div>
            ...
            <div class="opening-ساعات">
              <ul class="list-border">
                <li class="clearfix"> <span> الاحد - الخميس :  </span>
                  <div class="value pull-right flip"> 08.00 ص- 05.00 ظهراً</div>
                </li>
                <li class="clearfix"> <span> الفترة الثانية:  </span>
                  <div class="value pull-right flip"> 04.00 ص- 10.00م</div>
